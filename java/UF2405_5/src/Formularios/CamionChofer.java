 ...
 * @author Randy
 */
public class CamionChofer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblCamionChofer.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tblCamionChofer.setName(""); // NOI18N
        tblCamionChofer.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCamionChoferMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblCamionChofer);
    ...
    public void actualizarDatos() {
        try {
            String SQL = "update camion_chofer set NIF_Chofer=?, Matricula=?, Fecha=? where ID_Camion_Chofer = ?";
            int fila = tblCamionChofer.getSelectedRow();
            String nif = txtId.getText();
            if (fila > 0) {
                String dao = (String) tblCamionChofer.getValueAt(fila, 3);
                PreparedStatement pst = con.prepareStatement(SQL);
                int nifChofer = cmbNifChofer.getSelectedIndex();
    ...
    public void mostrarDatos() {
        String[] titulos = {"NIF Chofer", "Matricula", "Fecha", "ID Camion Chofer"};
        String[] registros = new String[4];
        DefaultTableModel modelo = new DefaultTableModel(null, titulos);
        try {
            String SQL = "SELECT * FROM camion_chofer;";
            Statement st = con.createStatement();
            ...
            while (rs.next()) {
                ...
                registros[3] = rs.getString("ID_Camion_Chofer");
                modelo.addRow(registros);
            }
            tblCamionChofer.setModel(modelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error de consulta" + e.getMessage());
        }
    }

    private void mostrarDatosCmbMatricula() {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        modelo.addElement("Seleccione Un Elemento");
        try {
            String SQL = "SELECT * FROM camion_chofer order by NIF_Chofer;";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(SQL);
            while (rs.next()) {
    ...
    private void mostrarDatosCmbNif() {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        modelo.addElement("Seleccione Un Elemento");
        try {
            String SQL = "SELECT * FROM camion_chofer order by Matricula;";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(SQL);
            while (rs.next()) {
                modelo.addElement(rs.getString("Matricula"));
            }
            cmbMatricula.setModel(modelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error de consulta" + e.getMessage());
        }
    }
    ...
    public void filtrarDatos(String valor) {
        ...
        DefaultTableModel modelo = new DefaultTableModel(null, titulos);
        try {
            String SQL = "SELECT * FROM camion_chofer where NIF_Chofer like '%" + valor + "%' or Matricula like'%" + valor + "%'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(SQL);
            while (rs.next()) {
                registros[0] = rs.getString("NIF_Chofer");
    ...
    private void tblCamionChoferMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCamionChoferMouseClicked
        // TODO add your handling code here:
        int filaSelect = tblCamionChofer.rowAtPoint(evt.getPoint());
        txtId.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CamionChofer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CamionChofer().setVisible(true);
            }
        });
    }
