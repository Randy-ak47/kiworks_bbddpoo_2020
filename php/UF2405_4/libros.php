        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <h1 class="display-3">Listado de Biblioteca - Libros</h1>
                    <table class="table">
                        <tr>
                            <td><h3><strong>Titulo</h3></strong></td>
                            <td><h3><strong>Precio</h3></strong></td>
                            <td><h3><strong>Autor</h3></strong></td>
                        </tr>
                </div>
                <?php
                ...
                include_once 'registros_1.php';
                include_once 'reg_libros.php';
                mysqli_close($link);
                ?>
                </table>      
                <div class="col clear">
                    ...
                    <form method="POST">
                        <table border="1" class="table  table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="submit" value="Guardar Registro" class="btn btn-primary btn-lg"></td>
                                </tr>
                            </tbody>
                        </table>
